...
[https://github.com/pydata/bokeh-governance](https://github.com/pydata/bokeh-governance)

The Project
===========

The Bokeh Project (The Project) is an open source software project affiliated
with the 501(c)3 NumFOCUS Foundation. 

Bokeh, a Python interactive visualization library, enables beautiful and meaningful 
visual presentation of data in modern web browsers. With Bokeh, you can quickly and 
easily create interactive plots, dashboards, and data applications.

Bokeh helps provide elegant, concise construction of novel graphics in the style of
D3.js, while also delivering high-performance interactivity over very large or
streaming datasets.

The Software developed by The Project is released under the BSD (or similar) open source 
license, developed openly and hosted in public GitHub repositories under the [PyData
GitHub organization](https://github.com/pydata). 

Examples of Project Software include:
-  The main Project code repository
-  the Project website
-  and assorted Project add-on libraries
...
Here is a list of the current Contributors to the main Project repository:

[https://github.com/pydata/bokeh/graphs/contributors](https://github.com/pydata/bokeh/graphs/contributors)
...
Traditionally, Project leadership was provided by a BDFL (Bryan Van de Ven)
and subset of Contributors, called the Core Team, whose active and consistent
...
rarely chooses to, override the Core Team and make a final decision on a matter.

While this approach has served The Project well, as the Project grows and faces
more legal and financial decisions and interacts with other institutions, we see a
...
Bryan Van de Ven. As Dictator, the BDFL has the authority to make all final
...
deadlock in the Core Team or if the Core Team asks the BDFL to make a decision
...
During the everyday project activities, the Core Team participates in all
discussions, code review and other project activities as peers with all other
Contributors and the Community. In these everyday activities, Core Team does not
...
they will be considered for removal from the Core Team. Before removal, the
...
In cases where the BDFL is not on a subcommittee, they should appoint a delegate
who plays that role most of the time and explicit BDFL intervention is sought
only if the committee disagrees with the delegate's decision and no resolution
is possible within the team. This is different from a BDFL delegate for a 
specific decision (or a recusal situation), where the BDFL is literally giving
up his/her authority to someone else in full.
...
Contributors and Core Team Members. Merely using Project Software or Services in
...
to do Project work and the Core Team decides to not pursue that work as a
Project, the Partner is free to pursue it on their own. However in this
situation, that part of the Partner’s work will not be under the Project
...
- Acknowledged on the Project website, in talks and T-shirts.
- Ability to acknowledge their own funding sources on the Project website, in
  talks and T-shirts.
